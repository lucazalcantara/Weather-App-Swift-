...
//  Weather App
//
//  Created by Lucas  Alcantara  on 12/10/24.
//
...
class ViewController: UIViewController {
    ...
    private lazy var statsStackView: UIStackView = {
        ...
        stackView.spacing = 3
        stackView.backgroundColor = UIColor.softGreyColor
    ...
    private func setConstraints(){
        ...
        NSLayoutConstraint.activate([
            cityLabel.topAnchor.constraint(equalTo: headerView.topAnchor, constant: 22),
            ...
            temperatureLabel.leadingAnchor.constraint(equalTo: headerView.leadingAnchor, constant: 36),
            weatherIcon.heightAnchor.constraint(equalToConstant: 94),
            weatherIcon.widthAnchor.constraint(equalToConstant: 94),
            weatherIcon.trailingAnchor.constraint(equalTo: headerView.trailingAnchor, constant: -30),
            weatherIcon.centerYAnchor.constraint(equalTo: temperatureLabel.centerYAnchor),
            weatherIcon.leadingAnchor.constraint(equalTo: temperatureLabel.trailingAnchor, constant: 20)
        ])
        ...
        NSLayoutConstraint.activate([
            ...
            hourlyCollectionView.topAnchor.constraint(equalTo:
                hourlyForecastLabel.bottomAnchor, constant: 22),
        ...
        NSLayoutConstraint.activate([
            ...
            dailyForecastTableView.topAnchor.constraint(equalTo: dailyForecastLabel.bottomAnchor, constant: 10),
...
extension ViewController: UICollectionViewDataSource, UITableViewDelegate{
